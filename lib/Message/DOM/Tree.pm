...
our $VERSION = 20060312.1158;
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2004/dom/tree#wf-invalid-character-in-node-name'} = {'description',
...
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2004/dom/tree#wf-invalid-character'} = {'description',
...
$Message::DOM::DOMCore::ManakaiDOMConfiguration{'Message::DOM::IFLatest::Document'}->{'http://suika.fam.cx/www/2006/dom-config/entity-reference-read-only'} = {'default',
'1',
'iname',
'etro',
'type',
...
['1',
'1']};
$Message::DOM::DOMCore::ManakaiDOMConfiguration{'Message::DOM::IFLatest::Document'}->{'http://suika.fam.cx/www/2006/dom-config/dtd-default-attributes'} = {'default',
'1',
'iname',
'dtddefault',
'type',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::Util::ManakaiNode::ManakaiNodeRef',
'Message::DOM::DOMMain::ManakaiDOMObject',
'Message::DOM::IF::Node',
...
report Message::DOM::DOMCore::ManakaiDOMError -object => $self, '-type' => 'http://suika.fam.cx/~wakaba/archive/2004/dom/main#empty-namespace-uri', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#resourceURI' => 'tag:suika.fam.cx,2005-09:tag:suika.fam.cx,2005-09:1142163035:19770:lSx4V38728+http://suika.fam.cx/~wakaba/archive/2004/8/18/manakai-dom%23ManakaiDOMLatest';
...
'==' => 'is_equal_node', 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMNode>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMChildNodeList>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMGetElementsNodeList>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMEmptyNodeList>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMAttrMap>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMElementTypeDefMap>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMAttrDefMap>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMEntityMap>} = {'core',
{'',
'1',
'1.0',
'1',
...
, 
fallback => 1;
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMNotationMap>} = {'core',
{'',
'1',
'1.0',
'1',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::DOM::Tree::ManakaiDOMAttrMap',
'Tie::Array';
sub FETCH ($$) {
my ($self, $index) = @_;
my $r;
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMAttrMapArray>} = {'core',
{'',
'1',
'1.0',
'1',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::DOM::Tree::ManakaiDOMElementTypeDefMap',
'Tie::Array';
sub FETCH ($$) {
my ($self, $index) = @_;
my $r;
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMElementTypeDefMapArray>} = {'core',
{'',
'1',
'1.0',
'1',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::DOM::Tree::ManakaiDOMAttrDefMap',
'Tie::Array';
sub FETCH ($$) {
my ($self, $index) = @_;
my $r;
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMAttrDefMapArray>} = {'core',
{'',
'1',
'1.0',
'1',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::DOM::Tree::ManakaiDOMEntityMap',
'Tie::Array';
sub FETCH ($$) {
my ($self, $index) = @_;
my $r;
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMEntityMapArray>} = {'core',
{'',
'1',
'1.0',
'1',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::DOM::Tree::ManakaiDOMNotationMap',
'Tie::Array';
sub FETCH ($$) {
my ($self, $index) = @_;
my $r;
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMNotationMapArray>} = {'core',
{'',
'1',
'1.0',
'1',
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMCharacterData>} = {'core',
{'',
'1',
'1.0',
'1',
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMAttr>} = {'core',
{'',
'1',
'1.0',
'1',
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::Tree::ManakaiDOMAttr>} = {'o',
['owner'],
's',
['child'],
'x',
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMElement>} = {'core',
{'',
'1',
'1.0',
'1',
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::Tree::ManakaiDOMElement>} = {'o',
['parent'],
's',
['child'],
's2',
...
our $VERSION = 20060312.1158;
push our @ISA, 'Message::DOM::Tree::ManakaiDOMCharacterData',
'Message::DOM::IF::CharacterData',
'Message::DOM::IF::Node',
'Message::DOM::IF::Text',
'Message::DOM::IFLatest::CharacterData',
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMText>} = {'core',
{'',
'1',
'1.0',
'1',
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::Tree::ManakaiDOMText>} = {'o',
['parent'],
'x',
['od']};
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMComment>} = {'core',
{'',
'1',
'1.0',
'1',
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::Tree::ManakaiDOMComment>} = {'o',
['parent'],
'x',
['od']};
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMDocumentFragment>} = {'core',
{'',
'1',
'1.0',
'1',
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::Tree::ManakaiDOMDocumentFragment>} = {'s',
['child'],
'x',
['od']};
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMDocument>} = {'core',
{'',
'1',
'1.0',
'1',
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::Tree::ManakaiDOMDocument>} = {'s',
['child']};
package Message::DOM::Tree::ManakaiDOMImplementationDocument;
our $VERSION = 20060312.1159;
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::DOM::Tree::ManakaiDOMImplementationDocument>} = {'http://suika.fam.cx/www/2006/feature/min',
{'',
'1',
'3.0',
'1'},
