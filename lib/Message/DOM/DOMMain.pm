...
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2004/dom/main#empty-namespace-uri'} = {'description', 'An empty string is used as a namespace URI.', 'sev', '1', 't', 'http://suika.fam.cx/~wakaba/archive/2004/dom/main#empty-namespace-uri'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2004/dom/main#empty-namespace-prefix'} = {'description', 'An empty string is used as a namespace prefix.', 'sev', '1', 't', 'http://suika.fam.cx/~wakaba/archive/2004/dom/main#empty-namespace-prefix'};
