...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::DOM::DOMMain::ManakaiDOMObject>}->{has_feature} = {};
...
for ($Message::DOM::IFLatest::DOMImplementationSource::, $Message::DOM::IFLevel3::DOMImplementationSource::, $Message::Util::Error::MUErrorTarget::){}
