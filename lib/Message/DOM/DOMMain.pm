...
#line 1 "lib/Message/DOM/DOMMain.dis [u] (Chunk #1)"
        ...
        my $al = our $AUTOLOAD;
        $al =~ s/.+:://;
        if ({'ATTR_SET_NO_EFFECT', 'Message::DOM::DOMMain::ATTR_SET_NO_EFFECT', 'BAD_BASE_URI', 'Message::DOM::DOMMain::BAD_BASE_URI', 'MDOMX_EMPTY_NS_PREFIX', 'Message::DOM::DOMMain::MDOMX_EMPTY_NS_PREFIX', 'MDOM_DOMSTRING_INDEX_IN_SURROGATE_PAIR', 'Message::DOM::DOMMain::MDOM_DOMSTRING_INDEX_IN_SURROGATE_PAIR', 'MDOM_NEWCHILD_IS_REFCHILD', 'Message::DOM::DOMMain::MDOM_NEWCHILD_IS_REFCHILD', 'MDOM_NS_EMPTY_URI', 'Message::DOM::DOMMain::MDOM_NS_EMPTY_URI', 'MDOM_REPLACE_BY_ITSELF_NO_EFFECT', 'Message::DOM::DOMMain::MDOM_REPLACE_BY_ITSELF_NO_EFFECT', 'RELATIVE_URI', 'Message::DOM::DOMMain::RELATIVE_URI'}->{$al}) {
          no strict 'refs';
          *{$AUTOLOAD} = \&{{'ATTR_SET_NO_EFFECT', 'Message::DOM::DOMMain::ATTR_SET_NO_EFFECT', 'BAD_BASE_URI', 'Message::DOM::DOMMain::BAD_BASE_URI', 'MDOMX_EMPTY_NS_PREFIX', 'Message::DOM::DOMMain::MDOMX_EMPTY_NS_PREFIX', 'MDOM_DOMSTRING_INDEX_IN_SURROGATE_PAIR', 'Message::DOM::DOMMain::MDOM_DOMSTRING_INDEX_IN_SURROGATE_PAIR', 'MDOM_NEWCHILD_IS_REFCHILD', 'Message::DOM::DOMMain::MDOM_NEWCHILD_IS_REFCHILD', 'MDOM_NS_EMPTY_URI', 'Message::DOM::DOMMain::MDOM_NS_EMPTY_URI', 'MDOM_REPLACE_BY_ITSELF_NO_EFFECT', 'Message::DOM::DOMMain::MDOM_REPLACE_BY_ITSELF_NO_EFFECT', 'RELATIVE_URI', 'Message::DOM::DOMMain::RELATIVE_URI'}->{$al}};
          goto &{$AUTOLOAD};
        } else {
          require Carp;
...
#line 1 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@type=dis:MultipleResource][@Name=StringExtend][@Name=ManakaiDOMStringExtend][@type=ManakaiDOM:IF][@type=ManakaiDOM:PrimitiveTypeClass]/Method[@Name=findOffset32][@type=DISLang|Method]/Return[@Type=unsigned-long||ManakaiDOM|all][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #15)"
my 
...
#line 1 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@type=dis:MultipleResource][@Name=StringExtend][@Name=ManakaiDOMStringExtend][@type=ManakaiDOM:IF][@type=ManakaiDOM:PrimitiveTypeClass]/Method[@Name=findOffset16][@type=DISLang|Method]/Return[@Type=DOMMain|unsigned-long||ManakaiDOM|all][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #25)"
my 
...
{'ATTR_SET_NO_EFFECT', {'description', 'Setting an attribute value has no effect by definition.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '0', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {'http://suika.fam.cx/~wakaba/archive/2004/dom/main#MDOMX_NOEFFECT_SINCE_DOC_NOSUPPORT_XML', {'description', 'The action has no effect since a document does not support the <Feature::XML> feature.'}, 'http://suika.fam.cx/~wakaba/archive/2004/dom/main#MDOMX_NOEFFECT_SINCE_NODE_NOSUPPORT_XMLNS', {'description', 'The action has no effect since a node does not support XML Namespaces.'}}}, 'BAD_BASE_URI', {'description', 'Malformed base URI reference is specified.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '5', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#NULL_BASE_URI', {'description', 'The specified base URI reference is <DOM::null>.'}, 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#RELATIVE_BASE_URI', {'description', 'The specified base URI reference is a relative URI reference.'}}}, 'MDOMX_EMPTY_NS_PREFIX', {'description', 'An empty namespace prefix is specified; its result is implementation dependent <SRC::DOM Level 3>.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '3', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {}}, 'MDOM_NEWCHILD_IS_REFCHILD', {'description', 'The node to be inserted is same as the reference node.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '1', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {}}, 'MDOM_NS_EMPTY_URI', {'description', 'An empty string namespace URI is coverted into <DOM::null> <SRC::DOM Level 3 Core>.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '4', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {}}, 'MDOM_REPLACE_BY_ITSELF_NO_EFFECT', {'description', 'An attempt to replace a node by itself is made. It is no effect by definition.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '2', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {}}, 'RELATIVE_URI', {'description', 'A relative URI reference is specified; the result is implementation dependent.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '6', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {}}}
...
{
#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/StringDataTypeDef[@QName=FeaturesString][@type=DISLang|DataType][@type=doc|Documentation]/InputProcessor[@type=DISLang:InputProcessor]/PerlDef [b] (Chunk #39)"

#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/StringDataTypeDef[@QName=FeaturesString][@type=DISLang|DataType][@type=doc|Documentation]/InputProcessor[@type=DISLang:InputProcessor]/PerlDef [bc] (Chunk #37)"
if 
#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/StringDataTypeDef[@QName=FeaturesString][@type=DISLang|DataType][@type=doc|Documentation]/InputProcessor[@type=DISLang:InputProcessor]/PerlDef [u] (Chunk #35)"
...
{
#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [b] (Chunk #71)"

#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #45)"

#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #41)"
$features->{core}->{'3.0'} = 
#line 1 "lib/Message/DOM/DOMMain.dis [/u] (Chunk #42)"
1
#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #43)"
;
...
#line 3 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #55)"

#line 3 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #53)"
;
...
{
#line 4 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [b] (Chunk #63)"

#line 4 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #61)"

  C: 
#line 4 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #57)"
for my $class (
...
#line 7 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #59)"
 ($features);
    last C if defined $r;
  }
...
#line 12 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #69)"

#line 12 "/document (lib/Message/DOM/DOMFeature.dis)/ResourceDef[@QName=ImplementationRegistry][@type=DISLang|Class][@type=doc|Documentation]/Method[@Name=getDOMImplementation][@type=DISLang|Method]/Return[@Type=MinimumImplementation][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #67)"
;
...
{
#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/StringDataTypeDef[@QName=FeaturesString][@type=DISLang|DataType][@type=doc|Documentation]/InputProcessor[@type=DISLang:InputProcessor]/PerlDef [b] (Chunk #77)"

#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/StringDataTypeDef[@QName=FeaturesString][@type=DISLang|DataType][@type=doc|Documentation]/InputProcessor[@type=DISLang:InputProcessor]/PerlDef [bc] (Chunk #75)"
if 
#line 1 "/document (lib/Message/DOM/DOMFeature.dis)/StringDataTypeDef[@QName=FeaturesString][@type=DISLang|DataType][@type=doc|Documentation]/InputProcessor[@type=DISLang:InputProcessor]/PerlDef [u] (Chunk #73)"
(CORE::defined $features) {
  if (CORE::ref ($features) eq 'HASH') {
    my $new = {};
    for my $fname (keys %{$features}) {
...
{
#line 1 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [b] (Chunk #95)"
...
{
#line 1 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [b] (Chunk #87)"

#line 1 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #85)"

#line 1 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #81)"
...
#line 3 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #83)"
;
...
#line 4 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [bc] (Chunk #93)"

#line 4 "/document (lib/Message/DOM/DOMMain.dis)/ResourceDef[@QName=DOMImplementationRegistry][@type=ManakaiDOM|Class]/Method[@Name=getDOMImplementationList][@type=DISLang|Method]/Return[@Type=DOMCore|DOMImplementationList][@type=DISLang|MethodReturn]/PerlDef [u] (Chunk #91)"
;
...
for ($Message::DOM::IFLevel3::DOMImplementationSource::, $Message::Util::IF::ManakaiDOMExceptionIF::, $Message::DOM::IFLevel3::StringIndexOutOfBoundsException::, $Message::DOM::IF::StringIndexOutOfBoundsException::, $Message::DOM::IFLevel2::StringIndexOutOfBoundsException::, $Message::Util::Error::MUErrorTarget::, $Message::DOM::IFLevel2::StringExtend::, $Message::DOM::IFLatest::DOMImplementationSource::, $Message::DOM::IF::StringExtend::, $Message::DOM::IFLatest::StringExtend::, $Message::DOM::IFLevel3::StringExtend::){}
