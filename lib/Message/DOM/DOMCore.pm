...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::DOMImplementationRegistry',
...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::DOMImplementationList';
sub length ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r = 0;
...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::DOMImplementationSource';
sub get_dom_implementation ($$) {
my ($self, $features) = @_;
...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::NameList';
sub get_name ($$) {
my ($self, $index) = @_;
my $r = '';
...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::DOMErrorHandler';
sub handle_error ($$) {
my ($self, $error) = @_;
my $r = 0;
...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::DOMLocator';
sub line_number ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r = 0;
...
our $VERSION = 20061230.0422;
push our @ISA, 'Message::DOM::IFLatest::DOMConfiguration';
sub ___report_error ($$) {
my ($self, $err) = @_;
...
for ($Message::DOM::IFLatest::GetFeature::, $Message::Util::Error::MUErrorTarget::){}
