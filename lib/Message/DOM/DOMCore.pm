...
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#check-character-normalization-failure'} = {'description', 'If the <cfg::check-character-normalization> configuration parameter is set to <DOM::true> and a sequence of characters is encountered that fails normalization checking. <SRC::DOM Level 3 Core> <SRC::DOM Level 3 LS>', 'sev', '2', 't', 'check-character-normalization-failure'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#cdata-sections-splitted'} = {'description', 'If the <cfg::split-cdata-sections> configuration parameter is set to <DOM::true> and a <XML::CDATA> section is split.', 'sev', '1', 't', 'cdata-sections-splitted'};
