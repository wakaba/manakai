...
for ($Message::DOM::IF::NamedNodeMap::, $Message::DOM::IF::Node::, $Message::DOM::IF::NodeList::, $Message::DOM::IFLevel1::NamedNodeMap::, $Message::DOM::IFLevel1::Node::, $Message::DOM::IFLevel1::NodeList::, $Message::DOM::IFLevel2::NamedNodeMap::, $Message::DOM::IFLevel2::Node::, $Message::DOM::IFLevel2::NodeList::, $Message::DOM::IFLevel3::NamedNodeMap::, $Message::DOM::IFLevel3::Node::, $Message::DOM::IFLevel3::NodeList::, $Message::Util::Error::MUErrorTarget::){}
