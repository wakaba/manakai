...
'1.1',
'1'}};
$Message::DOM::ClassPoint{q<Message::DOM::TreeStore::ManakaiDOMImplementationTreeStore>} = 15.1;
$Message::DOM::ManakaiDOMImplementationSource::SourceClass{q<Message::DOM::TreeStore::ManakaiDOMImplementationTreeStore>} = 1;
$Message::DOM::DOMFeature::ClassInfo->{q<Message::DOM::DOMFeature::ManakaiMinimumImplementation>}->{compat_class}->{q<Message::DOM::TreeStore::ManakaiDOMImplementationTreeStore>} = 1;
$Message::Util::Grove::ClassProp{q<Message::DOM::TreeStore::ManakaiDOMImplementationTreeStore>} = {'v1h',
['lpmi']};
for ($Message::DOM::IF::DOMImplementation::, $Message::DOM::IF::DOMImplementationTreeStore::, $Message::DOM::IFLatest::DOMImplementation::){}
