...
our %EXPORT_TAG = ('DeclaredValueType', ['CDATA_ATTR', 'ENTITIES_ATTR', 'ENTITY_ATTR', 'ENUMERATION_ATTR', 'IDREFS_ATTR', 'IDREF_ATTR', 'ID_ATTR', 'NMTOKENS_ATTR', 'NMTOKEN_ATTR', 'NOTATION_ATTR', 'UNKNOWN_ATTR'], 'DefaultValueType', ['EXPLICIT_DEFAULT', 'FIXED_DEFAULT', 'IMPLIED_DEFAULT', 'REQUIRED_DEFAULT', 'UNKNOWN_DEFAULT']);
our @EXPORT_OK = ('CDATA_ATTR', 'ENTITIES_ATTR', 'ENTITY_ATTR', 'ENUMERATION_ATTR', 'IDREFS_ATTR', 'IDREF_ATTR', 'ID_ATTR', 'NMTOKENS_ATTR', 'NMTOKEN_ATTR', 'NOTATION_ATTR', 'UNKNOWN_ATTR', 'EXPLICIT_DEFAULT', 'FIXED_DEFAULT', 'IMPLIED_DEFAULT', 'REQUIRED_DEFAULT', 'UNKNOWN_DEFAULT');
...
$Message::DOM::ClassPoint{q<Message::DOM::XDoctype::ManakaiDOMDocumentXDoctype>} = 25.2;
$Message::DOM::ManakaiDOMDocument::CompatClass{q<Message::DOM::XDoctype::ManakaiDOMDocumentXDoctype>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::XDoctype::ManakaiDOMDocumentXDoctype>} = {'o', ['parent'], 's', ['http://suika.fam.cx/~wakaba/archive/2004/dom/views#view', 'child'], 'x', ['od']};
...
report Message::DOM::DOMCore::ManakaiDOMException -object => $self, '-type' => 'NO_MODIFICATION_ALLOWED_ERR', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype' => 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#OWNER_DEFINITION_READ_ONLY_ERR', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#resourceURI' => 'tag:suika.fam.cx,2005-09:http://suika.fam.cx/~wakaba/archive/2004/dom/xdt%23setDefinitionNode+http://suika.fam.cx/~wakaba/archive/2004/8/18/manakai-dom%23ManakaiDOMLatest', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#param-name' => 'defNode', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#node' => $__owner;
...
$Message::DOM::ClassPoint{q<Message::DOM::XDoctype::ManakaiDOMDocumentTypeDefinition>} = 19.2;
$Message::DOM::ManakaiDOMDocumentType::CompatClass{q<Message::DOM::XDoctype::ManakaiDOMDocumentTypeDefinition>} = 1;
$Message::DOM::ManakaiDOMDocumentType::CompatClass{q<Message::DOM::XDoctype::ManakaiDOMDocumentTypeDefinition>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::XDoctype::ManakaiDOMDocumentTypeDefinition>} = {'o', ['parent', 'parent'], 's', ['child'], 's2', ['http://suika.fam.cx/~wakaba/archive/2004/dom/xdt#elementTypes', 'http://suika.fam.cx/~wakaba/archive/2004/dom/xdt#generalEntities', 'http://suika.fam.cx/~wakaba/archive/2004/dom/xdt#notations', 'http://suika.fam.cx/~wakaba/archive/2004/dom/xdt#parameterEntities'], 'x', ['od', 'od']};
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::DOM::XDoctype::ManakaiDOMElementTypeDefinition>} = {'o', ['http://suika.fam.cx/~wakaba/archive/2004/dom/xdt#ownerDefinition'], 's2', ['http://suika.fam.cx/~wakaba/archive/2004/dom/xdt#attributeDefinitions'], 'x', ['od']};
