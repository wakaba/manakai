...
our $VERSION = 20061104.0537;
package Message::DOM::IFLatest::GLSImplementation;
our $VERSION = 20061104.0537;
package Message::DOM::GenericLS::ManakaiGLSImplementation;
our $VERSION = 20061104.0537;
push our @ISA, 'Message::DOM::IFLatest::MinimumImplementation',
'Message::DOM::IFLatest::GLSImplementation',
'Message::DOM::IFLatest::GetFeature',
'Message::DOM::IFLatest::MinimumImplementation';
push @Message::DOM::DOMFeature::ManakaiMinimumImplementation::ISA, q<Message::DOM::GenericLS::ManakaiGLSImplementation> unless Message::DOM::DOMFeature::ManakaiMinimumImplementation->isa (q<Message::DOM::GenericLS::ManakaiGLSImplementation>);
