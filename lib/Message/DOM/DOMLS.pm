...
our $VERSION = 20060218.0536;
push our @ISA, 'Message::DOM::DOMCore::ManakaiDOMImplementation', 'Message::DOM::GenericLS::ManakaiGLSImplementation', 'Message::DOM::IF::DOMImplementationLS', 'Message::DOM::IFLatest::DOMImplementationLS', 'Message::DOM::IFLevel3::DOMImplementationLS';
...
2
      ...
      $feature{'LS-Async'} = '3.0';
    } else {
      last F;
    }
    if (defined $schemaType) {
      $feature{
'http://suika.fam.cx/www/2006/schema/'
.$schemaType} = '';
    }
    $r = $self->
create_gls_parser
...
$r = {}; # Output processor will |bless| it.
...
$Message::DOM::ClassFeature{q<Message::DOM::DOMLS::ManakaiDOMImplementationLS>} = {'', {'', '1'}, 'http://suika.fam.cx/www/2006/feature/genericls', {'', '1', '3.0', '1'}, 'http://suika.fam.cx/www/2006/feature/min', {'', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2004/8/18/manakai-dom#minimum', {'', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2004/dom/ls#generic', {'', '1', '3.0', '1'}, 'ls', {'', '1', '3.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
