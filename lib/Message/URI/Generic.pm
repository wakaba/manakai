...
'1.1',
'1'}};
$Message::DOM::ClassPoint{q<Message::URI::Generic::ManakaiURIImplementation>} = 12.1;
...
for ($Message::DOM::IF::DOMImplementation::, $Message::DOM::IFLatest::DOMImplementation::, $Message::URI::IF::URIImplementation::, $Message::URI::IF::URIReference::){}
