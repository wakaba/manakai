...
'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/MUErrorClass'
      ...
      ## DOM-style exception definitions
      if ($self->
is_type_uri

                                    (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/DOMException#Class'
) and @const) {
        my $err_def = $plimpl->
create_perl_sub
