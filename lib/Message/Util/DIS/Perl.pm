...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>}->{has_feature} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#perl',
{'',
'1',
'1.0',
'1'}};
...
$r = $Message::Util::DIS::Perl::Implementation;
