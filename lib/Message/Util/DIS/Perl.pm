...
is_type_uri
                       ...
                       (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#AnyMethod'
)) {
        my $method_code = $cls->
pl_code_fragment
;
...
'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#targetType'
        ...
        my $method_name_0 = shift @$method_names;
        my $type_uri_0 = shift @$type_uris;
        my $st = $r->
append_statement
;
        $st->
