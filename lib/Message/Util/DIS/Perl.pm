...
is_subset_of_uri
                       ...
                       (
'http://suika.fam.cx/~wakaba/archive/2004/dom/feature#ManakaiMinimumImplementationCompatible'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::DOMFeature::'.
                   'ManakaiMinimumImplementation>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
...
append_statement
                  ...
                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::Element::ManakaiDOMElement>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1')
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/AttributeRole'
)) {
...
append_statement
                  ...
                  ('$Message::DOM::DOMFeature::ClassInfo->{' .
                   'q<Message::DOM::Element::ManakaiDOMAttr>'.
                   '}->{compat_class_by_type}->{q<' . $etns .
                   '>}->{q<' . $etln .
                   '>}->{q<' . $ns . '>}->{q<' . $ln . '>}->{q<' .
                   $pack_name . '>} = 1');
            }
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/TextRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::TreeCore::ManakaiDOMText>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          if ($role->
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/CommentRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::TreeCore::ManakaiDOMComment>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          if ($role->
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/CDATASectionRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XML::ManakaiDOMCDATASection>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          if ($role->
is_subset_of_uri
...
append_statement
                ...
                ('$Message::DOM::DOMFeature::ClassInfo->{'.
                 'q<Message::DOM::XML::ManakaiDOMProcessingInstruction>'.
                 '}->{compat_class}->{q<' . $pack_name . '>} = 1');
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/DocumentRole'
)) {
            my $for_specific_et;
            for my $et (@{$cls->
get_property_resource_list
...
append_statement
                  ...
                  ('$Message::DOM::DOMFeature::ClassInfo->{' .
                   'q<Message::DOM::Document::ManakaiDOMDocument>'.
                   '}->{compat_class_by_type}->{q<' . $ns .
                   '>}->{q<' . $ln . '>}->{q<' . $pack_name . '>} = 1');
            }
            $r->
append_statement
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/DocumentFragmentRole'
)) {
            $r->
append_statement

                ('$Message::DOM::DOMFeature::ClassInfo->{'.
                 'q<Message::DOM::Document::ManakaiDOMDocumentFragment>'.
                 '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          if ($role->
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/DocumentTypeRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XDoctype::'.
                   'ManakaiDOMDocumentTypeDefinition>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/EntityRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XML::ManakaiDOMEntity>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/EntityReferenceRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XML::ManakaiDOMEntityReference>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
            ## TODO: Entity name or public ID dependent
          }
          if ($role->
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/NotationRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XML::ManakaiDOMNotation>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
...
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/NamespaceRole'
)) {
            $r->
append_statement

                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XPath::ManakaiDOMXPathNamespace>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          if ($role->
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/ElementTypeDefinitionRole'
)) {
            $r->
append_statement
                  ...
                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XDoctype::'.
                   'ManakaiDOMElementTypeDefinition>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          if ($role->
is_subset_of_uri
                        ...
                        (
'http://suika.fam.cx/~wakaba/archive/2005/manakai/DOM/TreeCore/AttributeDefinitionRole'
)) {
            $r->
append_statement
                  ...
                  ('$Message::DOM::DOMFeature::ClassInfo->{'.
                   'q<Message::DOM::XDoctype::'.
                   'ManakaiDOMAttributeDefinition>'.
                   '}->{compat_class}->{q<' . $pack_name . '>} = 1');
          }
          ## NOTE: tc:AnyNodeRole is subset of  
          ##       tc:ElementRole and tc:TextRole and ...
...
'Message::Util::IF::DISImplementationPerl';
push @Message::DOM::DOMCore::ManakaiDOMImplementation::ISA, q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl> unless Message::DOM::DOMCore::ManakaiDOMImplementation->isa (q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>);
...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>}->{has_feature} = {'',
{'',
'1'},
...
'1.1',
'1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>} = 12.1;
$Message::DOM::ManakaiDOMImplementationSource::SourceClass{q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>} = 1;
$Message::DOM::DOMFeature::ClassInfo->{q<Message::DOM::DOMFeature::ManakaiMinimumImplementation>}->{compat_class}->{q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>} = 1;
$Message::Util::Grove::ClassProp{q<Message::Util::DIS::Perl::ManakaiDISImplementationPerl>} = {'v1h',
['lpmi']};
