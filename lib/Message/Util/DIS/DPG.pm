...
sub AUTOLOAD {
        ...
        my $al = our $AUTOLOAD;
        $al =~ s/.+:://;
        if ({'PARSE_ERR', 'Message::Util::IF::DPGException::PARSE_ERR'}->{$al}) {
          no strict 'refs';
          *{$AUTOLOAD} = \&{{'PARSE_ERR', 'Message::Util::IF::DPGException::PARSE_ERR'}->{$al}};
          goto &{$AUTOLOAD};
        } else {
          require Carp;
...
our %EXPORT_TAG = ('DPGExceptionCode', ['PARSE_ERR']);
...
1
;
              $rstatement_to_code->($err_block, $child, 
1
,
                                    $rules, $root_rules, $factory);
            }
...
SCHAR__1____NAME__1___00000024name__1:
{
...
SASSIGN__1____EQUALS__1____REPLACE__1:
{
...
{'PARSE_ERR', {'description', 'An attempt was made to load a DPG document and the processing has been stopped.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '81', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype', {}}}
}
