...
'http://suika.fam.cx/~wakaba/archive/2005/11/pg/qMatch'
) {
        $parent->
append_atom
...
elsif (($token->{type} eq 'QKEYWORD') and ($token->{value} eq '?match')) 
{
