...
, 'type', 'object'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2005/11/pg/bad-token-error'} = {'description', 'Token "%p (name => {http://suika.fam.cx/~wakaba/archive/2005/11/pg/token-type});" is not allowed', 'sev', '2', 't', 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/bad-token-error'};
