...
$Message::DOM::Element::ElementClass->{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<*>} = q<Message::Util::DIS::DPG::ManakaiDPGElement>;
...
$location = {
    ...
    my $continue = 
report Message::DOM::DOMCore::ManakaiDOMError -object => $self, 'loc' => $location, '-type' => 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/bad-token-error', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#resourceURI' => 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#DPG/ManakaiDPGParser', 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/error-token' => $token, 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/source-text' => \($self->{source});

;
    unless ($continue) {
      
report Message::Util::DIS::DPG::ManakaiDPGException -object => $self, '-type' => 'PARSE_ERR', 'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#resourceURI' => 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#DPG/ManakaiDPGParser';
...
for ($Message::DOM::IF::Document::, $Message::DOM::IF::Element::, $Message::DOM::IF::Node::, $Message::Util::Error::MUErrorTarget::){}
