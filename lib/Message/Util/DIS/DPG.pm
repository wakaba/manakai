...
our $VERSION = 20060226.1040;
$Message::DOM::DOMCore::ManakaiDOMConfiguration{'Message::Util::IF::DPGParser'}->{'error-handler'} = {'checker', sub ($$$) {
...
, 'type', 'object'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2005/11/pg/bad-token-error'} = {'description', 'Token |%dpg-error-token-type;|%dpg-error-token-value (prefix => { (|}, suffix => {|)}); is not allowed %dpg-error-lines (prefix => {(|}, suffix => {|)});', 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/Core/textFormatter', 'Message::Util::DIS::DPG::ManakaiDPGExceptionFormatter', 'sev', '3', 't', 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/bad-token-error'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2005/11/pg/unique-lexmode-name-error'} = {'description', '|lexmode| |%p (name => {http://suika.fam.cx/~wakaba/archive/2005/11/pg/name});| is already defined', 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/Core/textFormatter', 'Message::Util::DIS::DPG::ManakaiDPGExceptionFormatter', 'sev', '2', 't', 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/unique-lexmode-name-error'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2005/11/pg/rule-not-defined-error'} = {'description', '|rule| |%p (name => {http://suika.fam.cx/~wakaba/archive/2005/11/pg/name});| is not defined', 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/Core/textFormatter', 'Message::Util::DIS::DPG::ManakaiDPGExceptionFormatter', 'sev', '2', 't', 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/rule-not-defined-error'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2005/11/pg/lexmode-not-defined-error'} = {'description', '|lexmode| |%p (name => {http://suika.fam.cx/~wakaba/archive/2005/11/pg/name});| is not defined', 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/Core/textFormatter', 'Message::Util::DIS::DPG::ManakaiDPGExceptionFormatter', 'sev', '2', 't', 'http://suika.fam.cx/~wakaba/archive/2005/11/pg/lexmode-not-defined-error'};
sub PARSE_ERR ();
sub VALIDITY_ERR ();
sub AUTOLOAD {
        ...
        my $al = our $AUTOLOAD;
        $al =~ s/.+:://;
        if ({'PARSE_ERR', 'Message::Util::IF::DPGException::PARSE_ERR', 'VALIDITY_ERR', 'Message::Util::IF::DPGException::VALIDITY_ERR'}->{$al}) {
          no strict 'refs';
          *{$AUTOLOAD} = \&{{'PARSE_ERR', 'Message::Util::IF::DPGException::PARSE_ERR', 'VALIDITY_ERR', 'Message::Util::IF::DPGException::VALIDITY_ERR'}->{$al}};
          goto &{$AUTOLOAD};
        } else {
          require Carp;
...
our %EXPORT_TAG = ('DPGExceptionCode', ['PARSE_ERR', 'VALIDITY_ERR']);
our @EXPORT_OK = ('PARSE_ERR', 'VALIDITY_ERR');
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGDocument>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGDocument>} = {'s', ['child']};
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
;}
$r}
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGRulesElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGRuleElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGMatchStatementElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGMatchStatementElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGMatchStatementElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<matchStatement>}->{q<Message::Util::DIS::DPG::ManakaiDPGMatchStatementElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGMatchStatementElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGMatchBlockElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGMatchElseBlockElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGMatchElseBlockElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGMatchElseBlockElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<matchElseBlock>}->{q<Message::Util::DIS::DPG::ManakaiDPGMatchElseBlockElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGMatchElseBlockElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
package Message::Util::IF::DPGMyStatementElement;
our $VERSION = 20060226.1040;
package Message::Util::DIS::DPG::ManakaiDPGMyStatementElement;
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGMyStatementElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGMyStatementElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGMyStatementElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<myStatement>}->{q<Message::Util::DIS::DPG::ManakaiDPGMyStatementElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGMyStatementElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
package Message::Util::IF::DPGEmbedStatementElement;
our $VERSION = 20060226.1040;
package Message::Util::DIS::DPG::ManakaiDPGEmbedStatementElement;
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGEmbedStatementElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGEmbedStatementElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGEmbedStatementElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<embedStatement>}->{q<Message::Util::DIS::DPG::ManakaiDPGEmbedStatementElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGEmbedStatementElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
package Message::Util::IF::DPGRuleRefStatementElement;
our $VERSION = 20060226.1040;
package Message::Util::DIS::DPG::ManakaiDPGRuleRefStatementElement;
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGRuleRefStatementElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGRuleRefStatementElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGRuleRefStatementElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<ruleRefStatement>}->{q<Message::Util::DIS::DPG::ManakaiDPGRuleRefStatementElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGRuleRefStatementElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGLexmodeElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGLAssignmentStatementElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
...
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGLQDefaultTokenStatementElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGLQDefaultTokenStatementElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGLQDefaultTokenStatementElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<lQDefaultTokenStatement>}->{q<Message::Util::DIS::DPG::ManakaiDPGLQDefaultTokenStatementElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGLQDefaultTokenStatementElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
package Message::Util::IF::DPGTokenErrorElement;
our $VERSION = 20060226.1040;
package Message::Util::DIS::DPG::ManakaiDPGTokenErrorElement;
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::DIS::DPG::ManakaiDPGElement', 'Message::Util::DIS::DPG::ManakaiDPGElementAttribute', 'Message::DOM::IFLatest::Element', 'Message::DOM::IFLatest::Node', 'Message::Util::IF::DPGElement', 'Message::Util::IF::DPGElementAttribute', 'Message::Util::IF::DPGTokenErrorElement';
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGTokenErrorElement>} = {'core', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}, 'xml', {'', '1', '1.0', '1', '2.0', '1', '3.0', '1'}, 'xmlversion', {'', '1', '1.0', '1', '1.1', '1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DPG::ManakaiDPGTokenErrorElement>} = 15.1;
$Message::DOM::ManakaiDOMElement::CompatClassET{q<http://suika.fam.cx/~wakaba/archive/2005/11/pg/>}->{q<tokenError>}->{q<Message::Util::DIS::DPG::ManakaiDPGTokenErrorElement>} = 1;
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::DPG::ManakaiDPGTokenErrorElement>} = {'o', ['parent'], 's', ['child'], 's2', ['attr'], 'x', ['od']};
package Message::Util::IF::DPGParser;
our $VERSION = 20060226.1040;
package Message::Util::DIS::DPG::ManakaiDPGParser;
our $VERSION = 20060226.1040;
push our @ISA, 'Message::Util::Error::MUErrorTarget', 'Message::Util::IF::DPGParser';
sub dom_config ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
...
return {'location', $location, 'type', 'SEMICOLON'};
...
return {'location', $location, 'type', 'NAME', 'value', $token_val};
...
return {'location', $location, 'type', 'CHAR', 'value', $token_val};
...
return {'location', $location, 'type', 'VARIABLE', 'value', $token_val};
...
return {'location', $location, 'type', 'RULEREF', 'value', $token_val};
...
return {'location', $location, 'type', 'QKEYWORD', 'value', $token_val};
...
return {'location', $location, 'type', 'ZEROONE'};
...
return {'location', $location, 'type', 'STRING', 'value', $token_val};
...
return {'location', $location, 'type', 'COMMA'};
...
return {'location', $location, 'type', 'REPLACE'};
...
return {'location', $location, 'type', 'EQUALS'};
...
return {'location', $location, 'type', 'ASSIGN'};
...
return {'location', $location, 'type', 'DEFINE'};
...
return {'location', $location, 'type', 'COLON'};
...
return {'location', $location, 'type', 'LPAREN'};
...
return {'location', $location, 'type', 'RPAREN'};
...
return {'location', $location, 'type', 'LBRACE'};
...
return {'location', $location, 'type', 'RBRACE'};
...
return {'location', $location, 'type', 'NCLSOPEN'};
...
return {'location', $location, 'type', 'CLSOPEN'};
...
return {'location', $location, 'type', 'CLSCLOSE'};
...
return {'location', $location, 'type', 'ZEROMORE'};
...
return {'location', $location, 'type', 'ONEMORE'};
...
return {'location', $location, 'type', 'MATCH'};
...
return {'location', $location, 'type', 'RANGE'};
...
return {'location', $location, 'type', 'DOT'};
...
return {'location', $location, 'type', 'RNI'};
...
return {'location', $location, 'type', 'LANGLE'};
...
return {'location', $location, 'type', 'RANGLE'};
...
return {'location', $location, 'type', '#EOF'};


}
return {'location', $location, 'type', '#INVALID', 'value', chr ($ch)};
...
sub PARSE_ERR () {
81}
$Message::Util::IF::DPGException::ErrorDef{'PARSE_ERR'} = {'description', 'An attempt was made to load a DPG document and the processing has been stopped.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '81'};
sub VALIDITY_ERR () {
10083}
$Message::Util::IF::DPGException::ErrorDef{'VALIDITY_ERR'} = {'description', 'An attempt was made to process an invalid DPG document and the processing has been stopped.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '10083'};
package Message::Util::DIS::DPG::ManakaiDPGException;
our $VERSION = 20060226.1041;
push our @ISA, 'Message::Util::Error::DOMException::Exception', 'Message::Util::IF::DPGException';
sub _FORMATTER_PACKAGE_ {
'Message::Util::DIS::DPG::ManakaiDPGExceptionFormatter'}
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGException>} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}};
...
our $VERSION = 20060226.1041;
push our @ISA, 'Message::Util::Error::formatter', 'Message::Util::IF::DPGExceptionFormatter';
sub ___rule_def {
{'dpg_error_lines', {'after', sub ($$$$) {
my ($self, $name, $p, $o) = @_;
...
}, 'dpg_error_token_type', {'after', sub ($$$$) {
my ($self, $name, $p, $o) = @_;
...
}, 'dpg_error_token_value', {'after', sub ($$$$) {
my ($self, $name, $p, $o) = @_;
...
$Message::DOM::ClassFeature{q<Message::Util::DIS::DPG::ManakaiDPGExceptionFormatter>} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#dpg', {'', '1', '1.0', '1'}};
