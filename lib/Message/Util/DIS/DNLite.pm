...
push @Message::DOM::DOMCore::ManakaiDOMImplementation::ISA,
'Message::Util::DIS::ManakaiDISImplementation',
'Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite';
...
'1.1',
'1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>} = 10.1;
