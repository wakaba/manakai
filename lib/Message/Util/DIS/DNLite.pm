...
## 	at 2006-11-05T02:56:12+00:00,
## 	from file "DIS/DNLite.dis",
...
'Message::Util::IF::DISImplementationDNLite';
push @Message::DOM::DOMCore::ManakaiDOMImplementation::ISA, q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite> unless Message::DOM::DOMCore::ManakaiDOMImplementation->isa (q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>);
...

{
  ...
  $r = bless {
    ns => {%{$opt{base_namespace_binding} or {}},
           %{$originalDocument->{
'node'
}
                           ->{
...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>}->{has_feature} = {'',
{'',
'1'},
...
'1.1',
'1'}};
$Message::DOM::ClassPoint{q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>} = 12.1;
$Message::DOM::ManakaiDOMImplementationSource::SourceClass{q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>} = 1;
$Message::DOM::DOMFeature::ClassInfo->{q<Message::DOM::DOMFeature::ManakaiMinimumImplementation>}->{compat_class}->{q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>} = 1;
$Message::Util::Grove::ClassProp{q<Message::Util::DIS::DNLite::ManakaiDISImplementationDNLite>} = {'v1h',
['lpmi']};
...
$r}
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::DNLite::ManakaiDNLNode>}->{has_feature} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#core',
{'',
'1',
'1.0',
'1'},
...
our $VERSION = 20061105.0256;
push our @ISA, 'Message::Util::DIS::DNLite::ManakaiDNLNode',
'Message::Util::IF::DNLDocument',
'Message::Util::IF::DNLNode',
'Message::Util::IFLatest::NSResolverDIS';
sub node_type ($;$) {
if (@_ == 1) {my ($self) = @_;
...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::DNLite::ManakaiDNLDocument>}->{has_feature} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#core',
{'',
'1',
'1.0',
'1'},
...
$r}
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::DNLite::ManakaiDNLElement>}->{has_feature} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#core',
{'',
'1',
'1.0',
'1'},
