...
$Message::DOM::ManakaiDOMImplementationSource::SourceClass{q<Message::Util::DIS::Value::ManakaiDISImplementationValue>} = 1;
$Message::DOM::DOMFeature::ClassInfo->{q<Message::DOM::DOMFeature::ManakaiMinimumImplementation>}->{compat_class}->{q<Message::Util::DIS::Value::ManakaiDISImplementationValue>} = 1;
$Message::Util::Grove::ClassProp{q<Message::Util::DIS::Value::ManakaiDISImplementationValue>} = {'v1h',
['lpmi']};
...
'Message::DOM::DOMFeature::ManakaiHasFeatureByGetFeature',
...
for ($Message::DOM::IFLatest::DOMImplementation::, $Message::DOM::IFLatest::GetFeature::, $Message::Util::IFLatest::NSResolverDIS::){}
