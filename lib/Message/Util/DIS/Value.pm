...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::Value::ManakaiDISImplementationValue>}->{has_feature} = {'http://suika.fam.cx/~wakaba/archive/2005/manakai/util/dis#value',
{'',
'1',
'1.0',
'1'}};
