...
#line 1 "lib/Message/Util/Error/DOMException.dis [u] (Chunk #1)"
        ...
        my $al = our $AUTOLOAD;
        $al =~ s/.+:://;
        if ({'MDOM_DEBUG_BUG', 'Message::Util::Error::DOMException::MDOM_DEBUG_BUG', 'NOT_SUPPORTED_ERR', 'Message::Util::Error::DOMException::NOT_SUPPORTED_ERR', 'NO_MODIFICATION_ALLOWED_ERR', 'Message::Util::Error::DOMException::NO_MODIFICATION_ALLOWED_ERR'}->{$al}) {
          no strict 'refs';
          *{$AUTOLOAD} = \&{{'MDOM_DEBUG_BUG', 'Message::Util::Error::DOMException::MDOM_DEBUG_BUG', 'NOT_SUPPORTED_ERR', 'Message::Util::Error::DOMException::NOT_SUPPORTED_ERR', 'NO_MODIFICATION_ALLOWED_ERR', 'Message::Util::Error::DOMException::NO_MODIFICATION_ALLOWED_ERR'}->{$al}};
          goto &{$AUTOLOAD};
        } else {
          require Carp;
