...
package Message::Util::Error::ManakaiDOMExceptionIF;
our $VERSION = 20050913.1138;
...
{
#line 1 "/document (lib/Message/Util/Error/DOMException.dis)/ResourceDef[@QName=ManakaiDefaultExceptionHandler][@type=ManakaiDOM:Class]/ResourceDef[@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [b] (Chunk #135)"

#line 1 "/document (lib/Message/Util/Error/DOMException.dis)/ResourceDef[@QName=ManakaiDefaultExceptionHandler][@type=ManakaiDOM:Class]/ResourceDef[@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [bc] (Chunk #133)"
if 
#line 1 "/document (lib/Message/Util/Error/DOMException.dis)/ResourceDef[@QName=ManakaiDefaultExceptionHandler][@type=ManakaiDOM:Class]/ResourceDef[@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #129)"
($err->isa (
#line 1 "lib/Message/Util/Error/DOMException.dis [/u] (Chunk #130)"
'Message::Util::Error::DOMException::ManakaiDOMException'
#line 1 "/document (lib/Message/Util/Error/DOMException.dis)/ResourceDef[@QName=ManakaiDefaultExceptionHandler][@type=ManakaiDOM:Class]/ResourceDef[@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #131)"
)) {
  $err->throw;
} else {
