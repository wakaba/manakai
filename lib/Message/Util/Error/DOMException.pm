...
sub AUTOLOAD {
        ...
        my $al = our $AUTOLOAD;
        $al =~ s/.+:://;
        if ({'MDOM_DEBUG_BUG', 'Message::Util::IF::ICoreException::MDOM_DEBUG_BUG', 'NOT_SUPPORTED_ERR', 'Message::Util::IF::ICoreException::NOT_SUPPORTED_ERR', 'NO_MODIFICATION_ALLOWED_ERR', 'Message::Util::IF::ICoreException::NO_MODIFICATION_ALLOWED_ERR'}->{$al}) {
          no strict 'refs';
          *{$AUTOLOAD} = \&{{'MDOM_DEBUG_BUG', 'Message::Util::IF::ICoreException::MDOM_DEBUG_BUG', 'NOT_SUPPORTED_ERR', 'Message::Util::IF::ICoreException::NOT_SUPPORTED_ERR', 'NO_MODIFICATION_ALLOWED_ERR', 'Message::Util::IF::ICoreException::NO_MODIFICATION_ALLOWED_ERR'}->{$al}};
          goto &{$AUTOLOAD};
        } else {
          require Carp;
...
sub MDOM_DEBUG_BUG () {
3}
$Message::Util::IF::ICoreException::ErrorDef{'MDOM_DEBUG_BUG'} = {'description', 'Unexpected case occurs. In general, this exception is not reported. If the implementation has a bug and something unexpected is occur, this exception is raised. Applications <kwd:MUST-NOT> try to catch this exception. If this exception is raised, please report to the author of that module. {NOTE:: New assertion mechanism and subtype <X::DOMMain|ASSERTION_ERR> has been introduced; it should be used instead of throwing <X::MDOMX:MDOM_DEBUG_BUG> directly. }', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '3'};
$Message::Util::IF::ICoreException::ErrorDef{'MDOM_DEBUG_BUG'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2004/dom/main#ASSERTION_ERR'} = {'description', 'Failure to pass an assertion.'};
sub NO_MODIFICATION_ALLOWED_ERR () {
7}
$Message::Util::IF::ICoreException::ErrorDef{'NO_MODIFICATION_ALLOWED_ERR'} = {'description', 'An attempt is made to modify read-only object.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '7'};
$Message::Util::IF::ICoreException::ErrorDef{'NO_MODIFICATION_ALLOWED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/DOMException#READ_ONLY_ATTRIBUTE_ERR'} = {'description', 'Attribute "%p (name => {http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#class}, suffix => {.} );%p (name => {http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#attr});" is read-only'};
sub NOT_SUPPORTED_ERR () {
9}
$Message::Util::IF::ICoreException::ErrorDef{'NOT_SUPPORTED_ERR'} = {'description', 'The implementation does not support the action.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '9'};
$Message::Util::IF::ICoreException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#MDOM_IMPL_ATTR_NOT_IMPLEMENTED'} = {'description', 'The attribute "%p (name => {http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#class}, suffix => {.} );%p (name => {http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#attr});" %p (name => {http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#on}, prefix => {(}, suffix => {)}); has not been implemented yet'};
...
our $VERSION = 20060305.0818;
push our @ISA, 'Message::Util::Error::DOMException::Exception', 'Message::Util::IF::ICoreException';
