...
$Message::Util::Grove::ClassProp{q<Message::Util::PerlCode::ManakaiPCHasFeature>} = {'o0',
['parent'],
's1a',
['child'],
's2hh',
...
$Message::Util::Grove::ClassProp{q<Message::Util::PerlCode::ManakaiPCElementType>} = {'o0',
['parent'],
's1a',
['child'],
's2hh',
...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::DOM::Document::ManakaiDOMDocument>}->{compat_class}->{q<Message::Util::PerlCode::ManakaiPCDocument>} = 1;
