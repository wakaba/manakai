...
{
#line 1 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [b] (Chunk #367)"

#line 1 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [bc] (Chunk #365)"
my 
#line 1 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #351)"
$node = $self->{
#line 1 "lib/Message/Util/ManakaiNode.dis [/u] (Chunk #352)"
'node'
#line 1 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #353)"
};
if ($node) {
  CORE::delete $self->{
#line 1 "lib/Message/Util/ManakaiNode.dis [/u] (Chunk #354)"
'node'
#line 3 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #355)"
};
  unless ($self->{
#line 1 "lib/Message/Util/ManakaiNode.dis [/u] (Chunk #356)"
'isWeak'
#line 4 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #357)"
}) {
    $node->{
#line 1 "lib/Message/Util/ManakaiNode.dis [/u] (Chunk #358)"
'rc'
#line 5 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #359)"
}--;
    unless ($node->
#line 1 "lib/Message/Util/ManakaiNode.dis [/u] (Chunk #360)"
_is_externally_referred
#line 6 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #361)"
) {
      $node->
#line 1 "lib/Message/Util/ManakaiNode.dis [/u] (Chunk #362)"
_destroy
#line 7 "/document (lib/Message/Util/ManakaiNode.dis)/ClassDef[@QName=NodeRef][@type=dis:MultipleResource]/IntMethod[@Name=destroy][@type=DISLang:Method]/Return[@type=DISLang:MethodReturn]/PerlDef [u] (Chunk #363)"
;
    }
  }
} else {
