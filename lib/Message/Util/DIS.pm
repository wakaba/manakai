...
our $VERSION = 20060223.1226;
$Message::DOM::DOMCore::ManakaiDOMConfiguration{'Message::Util::IFLatest::DISDatabase'}->{'error-handler'} = {'checker', sub ($$$) {
...
, 'type', 'object'};
$Message::DOM::DOMCore::ManakaiDOMError::Def{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#more-than-one-methods-for-a-type'} = {'description', 'Method |%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#method-name});| for resource <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> has multiple definitions', 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/Error/Core/textFormatter', 'Message::Util::Error::formatter', 'sev', '1', 't', 'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#more-than-one-methods-for-a-type'};
...
sub AUTOLOAD {
        ...
        my $al = our $AUTOLOAD;
        $al =~ s/.+:://;
        if ({'HIERARCHY_REQUEST_ERR', 'Message::Util::IFLatest::DISException::HIERARCHY_REQUEST_ERR', 'INVALID_SOURCE_ERR', 'Message::Util::IFLatest::DISException::INVALID_SOURCE_ERR', 'INVALID_STATE_ERR', 'Message::Util::IFLatest::DISException::INVALID_STATE_ERR', 'NOT_SUPPORTED_ERR', 'Message::Util::IFLatest::DISException::NOT_SUPPORTED_ERR'}->{$al}) {
          no strict 'refs';
          *{$AUTOLOAD} = \&{{'HIERARCHY_REQUEST_ERR', 'Message::Util::IFLatest::DISException::HIERARCHY_REQUEST_ERR', 'INVALID_SOURCE_ERR', 'Message::Util::IFLatest::DISException::INVALID_SOURCE_ERR', 'INVALID_STATE_ERR', 'Message::Util::IFLatest::DISException::INVALID_STATE_ERR', 'NOT_SUPPORTED_ERR', 'Message::Util::IFLatest::DISException::NOT_SUPPORTED_ERR'}->{$al}};
          goto &{$AUTOLOAD};
        } else {
          require Carp;
...
our %EXPORT_TAG = ('DISExceptionCode', ['HIERARCHY_REQUEST_ERR', 'INVALID_SOURCE_ERR', 'INVALID_STATE_ERR', 'NOT_SUPPORTED_ERR']);
our @EXPORT_OK = ('HIERARCHY_REQUEST_ERR', 'INVALID_SOURCE_ERR', 'INVALID_STATE_ERR', 'NOT_SUPPORTED_ERR');
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::ManakaiDISElement>} = {'o', ['p'], 's', ['swcn'], 's0', ['shadow', 'shadowsib']};
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::ManakaiDISComment>} = {'o', ['p'], 's', ['swcn']};
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::ManakaiDISDocumentFragment>} = {'o', ['p', 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#shadowParent', 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#shadowSiblingOf', 'shadowo'], 's', ['swcn']};
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::ManakaiDISDocument>} = {'o', ['p'], 's', ['swcn'], 's2', ['swetb']};
package Message::Util::IFLatest::DISDatabase;
our $VERSION = 20060223.1226;
package Message::Util::DIS::ManakaiDISDatabase;
our $VERSION = 20060223.1226;
push our @ISA, 'Message::Util::DIS::Perl::ManakaiDISDatabasePerl', 'Message::Util::IF::DISDatabase', 'Message::Util::IFLatest::DISDatabase';
sub get_module ($$%) {
...
uri
  ...
  F: for my $auri (%{$srres->{aliasURI} or {}}) {
...
our $VERSION = 20060223.1226;
push our @ISA, 'Message::Util::DIS::ManakaiDISAnyResource', 'Message::Util::Error::DOMException::ManakaiDefaultExceptionHandler', 'Message::DOM::IFLatest::GetFeature', 'Message::Util::IF::DISAnyResourcePerl', 'Message::Util::IF::DISModulePerl', 'Message::Util::IF::DISResourcePerlModule', 'Message::Util::IFLatest::DISResourceProp';
sub uris ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
...
our $VERSION = 20060223.1226;
push our @ISA, 'Message::Util::DIS::Perl::ManakaiDISAnyResourcePerl', 'Message::Util::DIS::ManakaiDISPropertyAccessor', 'Message::Util::DIS::ManakaiDISAnyResource', 'Message::Util::IF::DISFor', 'Message::Util::IFLatest::DISFor';
sub uris ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
...
our $VERSION = 20060223.1226;
push our @ISA, 'Message::Util::DIS::ManakaiDISResourceMV', 'Message::Util::DIS::Perl::ManakaiDISResourcePerl', 'Message::Util::DIS::Perl::ManakaiDISPerlModuleDefinition', 'Message::Util::DIS::Perl::ManakaiDISAnyResourcePerl', 'Message::Util::DIS::ManakaiDISPropertyAccessor', 'Message::Util::DIS::ManakaiDISAnyResource', 'Message::Util::IF::DISResource', 'Message::Util::IFLatest::DISResource';
sub uris ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
...
sub HIERARCHY_REQUEST_ERR () {
3}
$Message::Util::IFLatest::DISException::ErrorDef{'HIERARCHY_REQUEST_ERR'} = {'description', 'An attempt is made to break the hierarchy.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '3'};
$Message::Util::IFLatest::DISException::ErrorDef{'HIERARCHY_REQUEST_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#MERGE_ITSELF_ERR'} = {'description', 'An attempt is made to merge the resource <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri} );> to itself'};
sub NOT_SUPPORTED_ERR () {
9}
$Message::Util::IFLatest::DISException::ErrorDef{'NOT_SUPPORTED_ERR'} = {'description', 'An attempt is made to do something the implementation does not support.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '9'};
$Message::Util::IFLatest::DISException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNSUPPORTED_MEDIA_TYPE_ERR'} = {'description', '%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#sourceCode}, prefix => {"}, suffix => {": } );%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#elementType}, prefix => { (Element type: <}, suffix => {>) } );Media type <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> is not supported'};
$Message::Util::IFLatest::DISException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNSUPPORTED_ELEMENT_TYPE_ERR'} = {'description', 'Element type "%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#elementType});" is not supported'};
$Message::Util::IFLatest::DISException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_PERL_CODE_IMPL_ERR'} = {'description', 'There is no implementation that supports the <Feature::Util:PerlCode> feature, version <FeatureVer::1.0>.'};
sub INVALID_STATE_ERR () {
11}
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_STATE_ERR'} = {'description', 'An attempt is made to use an object that is not (or no longer) usable.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '11'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_STATE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_ASSOCIATED_DB_ERR'} = {'description', 'No <QUOTE::dis> database has been associated with this document.'};
sub INVALID_SOURCE_ERR () {
501}
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'} = {'description', 'The source input is well-formed but invalid.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '501'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_MODULE_QNAME_ERR'} = {'description', 'The <Q::dis:Module> element must have its <Q::dis:QName> attribute.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_LOCAL_NAME_ERR'} = {'description', 'The resource does not have a local name.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNABLE_TO_GET_MODULE_ERR'} = {'description', 'Unable to get the module source of <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});>'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_FOR_QNAME_ERR'} = {'description', 'A <Q::dis:ForDef> element must have <Q::dis:QName> attribute.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#FOR_ALREADY_DEFINED_ERR'} = {'description', '<QUOTE::For> <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> is already defined'};
...
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_SOURCE_NODE_ERR'} = {'description', 'A resource does not have associated node in the source tree.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#RESERVED_PERL_METHOD_NAME_ERR'} = {'description', 'A reserved Perl method name is used.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_DIS_TYPE_ERR'} = {'description', 'Resource "%t (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});" has no "dis:Type" attribute'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_METHOD_RETURN_ERR'} = {'description', 'Method "%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#localName});" does not have "Return" child'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_ATTR_GET_ERR'} = {'description', 'A <Q::DISLang:Attribute> resource does not have any <Q::DISLang:AttributeGet> child.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#INTERFACE_CLASS_METHOD_ERR'} = {'description', 'An attempt is made to call a static (class) method from an interface.'};
...
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_ELEMENT_TYPE_ERR'} = {'description', '%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#sourceCode}, prefix => {"}, suffix => {": });Element type name is not specified'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_PERL_PACKAGE_NAME_ERR'} = {'description', '%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri}, prefix => {<}, suffix => {>: });Perl package name is not defined'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_EXCEPTION_TYPE_ERR'} = {'description', 'An exception type specification is required.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_CODE_NAME_ERR'} = {'description', 'A code name specification is required.'};
...
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_METHOD_ERR'} = {'description', 'A preprocessing instruction which is only allowed in method definitions is used in a code which is not a method.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_FOR_ERR'} = {'description', 'A <QUOTE::for> specification is required.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_ASSERT_TYPE_ERR'} = {'description', 'An assertion type specification is required.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_BLOCK_NOT_ALLOWED_ERR'} = {'description', 'A preprocessing instruction block occurred with element type which does not allow it.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NON_NAMED_PARAMETER_AFTER_NAMED_ERR'} = {'description', 'A non-named method parameter following any named method parameter is occurred.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#DISPERL_NO_VALUE_ALLOWED_ERR'} = {'description', 'An element node have a value but the definition of that element type does not allow it.'};
...
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_ATTR_SET_ERR'} = {'description', 'An attribute setter is referred but the attribute does not define any setter.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_SUBROUTINE_ALREADY_DEFINED_ERR'} = {'description', 'A resource defines a Perl subroutine whose name is same as another subroutine.'};
...
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_UNUSED_SUBROUTINE_ERR'} = {'description', 'A resource defines a Perl subroutine but it is not used.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_LICENSE_ATTR_ERR'} = {'description', 'The <Q::dis:Module> element does not have the <Q::dis:License> attribute.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNSUPPORTED_ROLE_ERR'} = {'description', 'Role <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> is not supported'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_REFLECT_GET_DEFINED_ERR'} = {'description', 'An attribute is defined to reflect an element attribute but no reflecting attribute getter template is defined.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_REFLECT_SET_DEFINED_ERR'} = {'description', 'An attribute is defined to reflect an element attribute but no reflecting attribute setter template is defined.'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_END_TAG_ERR'} = {'description', 'End tag for element "%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#elementType});" is required%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#sourceCode}, prefix => { (}, suffix => {)});'};
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_RDF_TYPE_ERR'} = {'description', 'Resource%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri}, prefix => { "}, suffix => {"}); does not have "rdf:type" attribute'};
...
$Message::Util::IFLatest::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_EXCEPTION_CLASS_ERR'} = {'description', 'Exception interface <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});>: There is no class that implements this interface'};
package Message::Util::DIS::ManakaiDISException;
our $VERSION = 20060223.1226;
push our @ISA, 'Message::Util::Error::DOMException::Exception', 'Message::Util::IF::DISException', 'Message::Util::IFLatest::DISException';
sub text ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
