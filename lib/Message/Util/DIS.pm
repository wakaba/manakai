...
is_type_uri
                  ...
                  (
'http://suika.fam.cx/~wakaba/archive/2004/dis/Source#SourceProperty'
) ||
         $rdef->
is_type_uri
 (
...
our $VERSION = 20060219.1231;
push our @ISA, 'Message::Util::DIS::Perl::ManakaiDISAnyResourcePerl', 'Message::Util::DIS::ManakaiDISPropertyAccessor', 'Message::Util::DIS::ManakaiDISAnyResource', 'Message::Util::Error::DOMException::ManakaiDefaultExceptionHandler', 'Message::Util::IF::DISFor', 'Message::Util::IFLatest::DISFor';
sub uris ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
