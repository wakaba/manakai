...
our $VERSION = 20061231.0921;
$Message::DOM::DOMCore::ManakaiDOMConfiguration{'Message::Util::IF::DISDatabase'}->{'error-handler'} = {'checker',
sub ($$$) {
...
'Message::Util::IF::DISException::HIERARCHY_REQUEST_ERR',
'INVALID_SOURCE_ERR',
'Message::Util::IF::DISException::INVALID_SOURCE_ERR',
'INVALID_STATE_ERR',
'Message::Util::IF::DISException::INVALID_STATE_ERR',
'NOT_SUPPORTED_ERR',
'Message::Util::IF::DISException::NOT_SUPPORTED_ERR'}->{$al}) {
          no strict 'refs';
...
package Message::Util::IF::DISImplementation;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISParser;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISNode;
our $VERSION = 20061231.0921;
...
Message::Util::IF::DISException with 
{
      my $err = shift;
      $err->throw
        unless $err->{
...
package Message::Util::IF::NSResolverDIS;
our $VERSION = 20061231.0921;
...
my ($self, $tfpqnames, $defaultTypeURI, %opt) = @_;
my $r = '';

{

my 
($typeq, undef, @forpq) = split /\s*[:|][:|]\s*/, $tfpqnames;
my ($typeURI);
my $forpURI = [];
...
package Message::Util::IF::DISElement;
our $VERSION = 20061231.0921;
...
['shadow',
'shadowsib']};
package Message::Util::IF::DISModuleElement;
our $VERSION = 20061231.0921;
...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::ManakaiDISModuleElement>} = {'o',
['p'],
's',
['swcn'],
's0',
['shadow',
'shadowsib']};
package Message::Util::IF::DISElementList;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISComment;
our $VERSION = 20061231.0921;
...
's',
['swcn']};
package Message::Util::IF::DISDocumentFragment;
our $VERSION = 20061231.0921;
...
's',
['swcn']};
package Message::Util::IF::DISDocument;
our $VERSION = 20061231.0921;
...
's2',
['swetb']};
package Message::Util::IF::DISDatabase;
our $VERSION = 20061231.0921;
...
if 
(defined $self->{modDef}->{$moduleURI}) {
  $r = $self->{modDef}->{$moduleURI};
} else {
  $r = $self->{modDef}->{$moduleURI}
     = bless {
         uri => $moduleURI,
...
,
  ...
  my $al_canon_uri;
  if ($al_node) {
    $al_canon_uri = $al_node->qname_value_uri;
  }
...
$r = bless [$self, $self, 'Message::Util::IF::DISDatabase'],
...
package Message::Util::IF::DISModuleResolver;
our $VERSION = 20061231.0921;
package Message::Util::DIS::ManakaiDISModuleResolver;
our $VERSION = 20061231.0921;
push our @ISA, 'Message::Util::IF::DISModuleResolver';
sub uri_to_document ($$$$$) {
my ($self, $disDB, $moduleURI, $moduleNamespaceURI, $moduleLocalName) = @_;
my $r;
...
package Message::Util::IF::DISAnyResource;
our $VERSION = 20061231.0921;
package Message::Util::DIS::ManakaiDISAnyResource;
our $VERSION = 20061231.0921;
push our @ISA, 'Message::Util::IF::DISAnyResource';
sub uri ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
...
;
          ...
          my %mtopt = (default_media_type => $prop->
default_lextype_uri
,
                       database_arg => $db);
...
,
            ...
            unless (defined $factory) {
              $factory = $opt{implementation}->create_document;
            }
            my $mt = $db->
get_resource
...
package Message::Util::IF::DISModule;
our $VERSION = 20061231.0921;
...
'Message::Util::IF::DISResourceProp';
sub uri ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
...
package Message::Util::IF::DISFor;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISResource;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISResourceMV;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISResourceProp;
our $VERSION = 20061231.0921;
...
package Message::Util::IF::DISException;
our $VERSION = 20061231.0921;
push our @ISA, 'Message::Util::Error';

sub ___error_def () {
  \%Message::Util::IF::DISException::ErrorDef
}

sub HIERARCHY_REQUEST_ERR () {
3}
$Message::Util::IF::DISException::ErrorDef{'HIERARCHY_REQUEST_ERR'} = {'description',
'An attempt is made to break the hierarchy.',
'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code',
'3'};
$Message::Util::IF::DISException::ErrorDef{'HIERARCHY_REQUEST_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#MERGE_ITSELF_ERR'} = {'description',
'An attempt is made to merge the resource <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri} );> to itself'};
sub NOT_SUPPORTED_ERR () {
9}
$Message::Util::IF::DISException::ErrorDef{'NOT_SUPPORTED_ERR'} = {'description',
'An attempt is made to do something the implementation does not support.',
'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code',
'9'};
$Message::Util::IF::DISException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNSUPPORTED_MEDIA_TYPE_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNSUPPORTED_ELEMENT_TYPE_ERR'} = {'description',
'Element type "%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#elementType});" is not supported'};
sub INVALID_STATE_ERR () {
11}
$Message::Util::IF::DISException::ErrorDef{'INVALID_STATE_ERR'} = {'description',
'An attempt is made to use an object that is not (or no longer) usable.',
'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code',
'11'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_STATE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_ASSOCIATED_DB_ERR'} = {'description',
'No <QUOTE::dis> database has been associated with this document.'};
sub INVALID_SOURCE_ERR () {
501}
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'} = {'description',
'The source input is well-formed but invalid.',
'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code',
'501'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_MODULE_QNAME_ERR'} = {'description',
'The <Q::dis:Module> element must have its <Q::dis:QName> attribute.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_LOCAL_NAME_ERR'} = {'description',
'The resource does not have a local name.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNABLE_TO_GET_MODULE_ERR'} = {'description',
'Unable to get the module source of <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});>'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_FOR_QNAME_ERR'} = {'description',
'A <Q::dis:ForDef> element must have <Q::dis:QName> attribute.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#FOR_ALREADY_DEFINED_ERR'} = {'description',
'<QUOTE::For> <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> is already defined'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#RESOURCE_ALREADY_DEFINED_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#ELEMENT_NOT_ALLOWED_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_REQUIRED_ATTR_ERR'} = {'description',
'Attribute <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#elementType});> must be specified'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#FOR_NOT_DEFINED_ERR'} = {'description',
'<QUOTE::For> <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> is not defined'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#RESOURCE_NOT_DEFINED_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_SOURCE_NODE_ERR'} = {'description',
'A resource does not have associated node in the source tree.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#RESERVED_PERL_METHOD_NAME_ERR'} = {'description',
'A reserved Perl method name is used.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_DIS_TYPE_ERR'} = {'description',
'Resource "%t (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});" has no "dis:Type" attribute'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_METHOD_RETURN_ERR'} = {'description',
'Method "%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#localName});" does not have "Return" child'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_ATTR_GET_ERR'} = {'description',
'A <Q::DISLang:Attribute> resource does not have any <Q::DISLang:AttributeGet> child.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#INTERFACE_CLASS_METHOD_ERR'} = {'description',
'An attempt is made to call a static (class) method from an interface.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#BROKEN_PARAM_SPEC_ERR'} = {'description',
'%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#sourceCode}, prefix => {"}, suffix => {": });Broken parameter specification'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_ELEMENT_TYPE_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_PERL_PACKAGE_NAME_ERR'} = {'description',
'%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri}, prefix => {<}, suffix => {>: });Perl package name is not defined'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_EXCEPTION_TYPE_ERR'} = {'description',
'An exception type specification is required.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_CODE_NAME_ERR'} = {'description',
'A code name specification is required.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_CODE_NOT_DEFINED_ERR'} = {'description',
'Resource%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri}, prefix => { "}, suffix => {"}); has no Perl code definition'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_METHOD_ERR'} = {'description',
'A preprocessing instruction which is only allowed in method definitions is used in a code which is not a method.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_FOR_ERR'} = {'description',
'A <QUOTE::for> specification is required.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_NO_ASSERT_TYPE_ERR'} = {'description',
'An assertion type specification is required.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_PREPROCESS_BLOCK_NOT_ALLOWED_ERR'} = {'description',
'A preprocessing instruction block occurred with element type which does not allow it.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NON_NAMED_PARAMETER_AFTER_NAMED_ERR'} = {'description',
'A non-named method parameter following any named method parameter is occurred.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#DISPERL_NO_VALUE_ALLOWED_ERR'} = {'description',
'An element node have a value but the definition of that element type does not allow it.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_CONST_VALUE_ERR'} = {'description',
'The source element node for a constant value resource does not have <Q::dis:Value> attribute.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_ATTR_SET_ERR'} = {'description',
'An attribute setter is referred but the attribute does not define any setter.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_SUBROUTINE_ALREADY_DEFINED_ERR'} = {'description',
'A resource defines a Perl subroutine whose name is same as another subroutine.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_OPERATOR_ALREADY_OVERLOADED_ERR'} = {'description',
'A resource is defined to overload a Perl operator which is already overloaded by another resource.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_UNUSED_SUBROUTINE_ERR'} = {'description',
'A resource defines a Perl subroutine but it is not used.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_LICENSE_ATTR_ERR'} = {'description',
'The <Q::dis:Module> element does not have the <Q::dis:License> attribute.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNSUPPORTED_ROLE_ERR'} = {'description',
'Role <%p (name => {http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#uri});> is not supported'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_REFLECT_GET_DEFINED_ERR'} = {'description',
'An attribute is defined to reflect an element attribute but no reflecting attribute getter template is defined.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_REFLECT_SET_DEFINED_ERR'} = {'description',
'An attribute is defined to reflect an element attribute but no reflecting attribute setter template is defined.'};
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_END_TAG_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_RDF_TYPE_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#PERL_HASH_KEY_ALREADY_DEFINED_ERR'} = {'description',
...
$Message::Util::IF::DISException::ErrorDef{'INVALID_SOURCE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#NO_EXCEPTION_CLASS_ERR'} = {'description',
...
for ($Message::DOM::IF::DOMImplementation::, $Message::Markup::IF::SWCFGParser::, $Message::Util::IF::DISAnyResourcePerl::, $Message::Util::IF::DISModulePerl::, $Message::Util::IF::DISResourcePerlModule::){}
