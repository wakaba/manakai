...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Util::DIS::ManakaiDISDocumentFragment>} = {'o', ['shadowo', 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#shadowParent', 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#shadowSiblingOf', 'p'], 's', ['swcn']};
...
Message::Util::DIS::Value::ManakaiDISImplementationValue->create_dv_value
                ...
                ($new_value_type, $v, base_type => $base_type = 'http://suika.fam.cx/~wakaba/archive/2004/dis/Core#String');
