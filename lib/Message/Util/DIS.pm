...
$Message::DOM::DOMFeature::ClassInfo->{q<Message::Util::DIS::ManakaiDISImplementation>}->{has_feature} = {'http://suika.fam.cx/www/2006/feature/min',
{'',
'1',
'3.0',
'1'},
