...
our $VERSION = 20060225.1649;
push our @ISA, 'Message::DOM::IFLatest::GetFeature', 'Message::Util::IF::DISAnyResourcePerl', 'Message::Util::IF::DISModulePerl', 'Message::Util::IF::DISResourcePerlModule', 'Message::Util::IFLatest::DISResourceProp';
sub uri ($;$) {
if (@_ == 1) {my ($self) = @_;
my $r;
