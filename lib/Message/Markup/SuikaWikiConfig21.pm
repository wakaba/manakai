...
$Message::Util::ManakaiNode::ManakaiNodeRef::Prop{q<Message::Markup::SuikaWikiConfig21::ManakaiSWCFGDocumentFragment>} = {'o', ['p', 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#shadowParent', 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#shadowSiblingOf', 'shadowo'], 's', ['swcn']};
...
sub HIERARCHY_REQUEST_ERR () {
3}
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'HIERARCHY_REQUEST_ERR'} = {'description', 'An attempt is made to insert a node somewhere it does not belong.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '3'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'HIERARCHY_REQUEST_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#HIERARCHY_ANCESTOR_OR_SELF_ERR'} = {'description', 'An attempt is made to insert an ancestor of this node or this node itself.'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'HIERARCHY_REQUEST_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#HIERARCHY_BAD_TYPE_ERR'} = {'description', 'An attempt is made to insert a node %p ( name => {http://suika.fam.cx/~wakaba/archive/2005/swcfg21#childNodeType}, prefix => { of type }); into the node %p (name => {http://suika.fam.cx/~wakaba/archive/2005/swcfg21#parentNodeType}, prefix => {of type });, which is not allowed'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'HIERARCHY_REQUEST_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#HIERARCHY_NO_VALUE_ERR'} = {'description', 'An attempt is made to set a node value for a %p (name => {http://suika.fam.cx/~wakaba/archive/2005/swcfg21#parentNodeType}); node'};
sub WRONG_DOCUMENT_ERR () {
4}
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'WRONG_DOCUMENT_ERR'} = {'description', 'A node is used in a different document than the one for which it is created.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '4'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'WRONG_DOCUMENT_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#EXTERNAL_NODE_ERR'} = {'description', 'An attempt is made to append a node created for another document'};
sub TYPE_MISMATCH_ERR () {
17}
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'TYPE_MISMATCH_ERR'} = {'description', 'The type of an object is incompatible with the type of the parameter.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '17'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'TYPE_MISMATCH_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#BAD_VALUE_ERR'} = {'description', 'A value%p (name => {http://suika.fam.cx/~wakaba/archive/2005/swcfg21#actualType}, prefix => { of type }); is specified where only either string or array reference is allowed'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'TYPE_MISMATCH_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#NOT_NODE_ERR'} = {'description', 'The type of an object is not <IF::SWCFGNode>.'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'TYPE_MISMATCH_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#APPEND_NULL_TEXT_ERR'} = {'description', 'An attempt is made to append a <DOM::null> value.'};
sub NOT_SUPPORTED_ERR () {
9}
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'NOT_SUPPORTED_ERR'} = {'description', '', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '9'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'NOT_SUPPORTED_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#SWCFG_VERSION_NOT_SUPPORTED_ERR'} = {'description', 'The implementation does not support the specified version of SuikaWikiConfig.'};
sub NAMESPACE_ERR () {
14}
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'NAMESPACE_ERR'} = {'description', 'An error related to namespaces has occurred.', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '14'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'NAMESPACE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/manakai/Util/DIS#UNDECLARED_NS_PREFIX_ERR'} = {'description', 'Namespace prefix "%p (name => {http://www.w3.org/2001/04/infoset#prefix});" is not declared'};
sub PARSE_ERR () {
81}
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'PARSE_ERR'} = {'description', '', 'http://suika.fam.cx/~wakaba/archive/2004/8/18/dom-core#code', '81'};
$Message::Markup::IFLatest::SWCFGException::ErrorDef{'PARSE_ERR'}->{'http://suika.fam.cx/~wakaba/archive/2004/8/4/manakai-dom-exception#subtype'}->{'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#SWCFG_PARSE_ERR'} = {'description', 'The implementation is unable to read and parse the SuikaWikiConfig document.'};
...
$Message::DOM::ClassFeature{q<Message::Markup::SuikaWikiConfig21::ManakaiSWCFGImplementation>} = {'http://suika.fam.cx/www/2006/feature/min', {'', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2004/8/18/manakai-dom#minimum', {'', '1', '3.0', '1'}, 'http://suika.fam.cx/~wakaba/archive/2005/swcfg21#core', {'', '1', '2.1', '1'}};
