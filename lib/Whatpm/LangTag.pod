...
=item BOOL = Whatpm::LangTag->basic_filtering_range_rfc4647 ($range, $tag)
...
=item BOOL = Whatpm::LangTag->match_range_rfc3066 ($range, $tag)
...
C<basic_filtering_range_rfc4647> by definition.

=item BOOL = Whatpm::LangTag->extended_filtering_range_rfc4647 ($range, $tag)
