...
=head1 SYNOPSIS
  ...
  Whatpm::LangTag->check_rfc5646_tag ($parsed, $onerror);
...
=item Whatpm::LangTag->check_rfc5646_tag ($parsed, $onerror)
...
=item Whatpm::LangTag->check_rfc4646_tag ($parsed, $onerror)
