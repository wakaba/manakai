...
For the SuikaWiki/0.9 namespace
(C<urn:x-suika-fam-cx:markup:suikawiki:0:9:>), the namespace
designator is C<sw>.  For the SuikaWiki/0.10 namespace
(C<urn:x-suika-fam-cx:markup:suikawiki:0:10:>), the namespace
designator is C<sw10>.  For the Temma namespace
(C<http://suika.fam.cx/www/markup/temma>), the namespace designator is
C<temma>.  For the Temma Macro namespace
(C<http://suika.fam.cx/www/markup/temma/macro>), the namespace
designator is C<temmacro>.
